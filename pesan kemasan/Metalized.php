...
<!-- Header -->
        ...
        <div class="info">
            <div class="container">
                <div class="info-box">
                    <div class="info-text">
                        <h2>Ukuran dan Harga Kemasan Sachet Metalize</h2>
                    ...
                    <div class="tabel">
                        <div class="info-tabel">
                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="cell"><strong>60 × 90 mm</strong></div>
                                    <div class="cell"></div>
                                    <div class="cell"></div>
                                    <div class="cell"></div>
                                    <div class="cell"></div>
                                ...
                                <div class="row highlight">
                                    <div class="cell"><strong>100 × 120 mm</strong></div>
                                    <div class="cell">Matte</div>
                                ...
                                <!-- Row 3 -->
                                <div class="row3">
                                    <div class="cell"><strong>120 × 180 mm</strong></div>
                                    <div class="cell"></div>
                                    <div class="cell"></div>
                                    <div class="cell"></div>
                                    <div class="cell"></div>
